package com.travcoffilm.onlineresume.web.rest;
...
import com.travcoffilm.onlineresume.config.KafkaProperties;
...
class TravcoffilmOnlineResumeKafkaResourceIT {
    ...
    void setup() {
        ...
        TravcoffilmOnlineResumeKafkaResource kafkaResource = new TravcoffilmOnlineResumeKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/travcoffilm-online-resume-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/travcoffilm-online-resume-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
