...
@RestController
@RequestMapping("/api/travcoffilm-online-resume-kafka")
public class TravcoffilmOnlineResumeKafkaResource {
    private final Logger log = LoggerFactory.getLogger(TravcoffilmOnlineResumeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TravcoffilmOnlineResumeKafkaResource(KafkaProperties kafkaProperties) {
